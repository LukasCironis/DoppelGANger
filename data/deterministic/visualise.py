...
synth_npz = np.load(os.path.join("..","..", "test\\backup_deterministic_30000\\test\\generated_samples\\epoch_id-9999\\generated_data_train.npz"))
...
pd.DataFrame(real_atribute_np, columns = [
    "type_glag1",
    "type_glag2",
    "freq",
    "shift",
